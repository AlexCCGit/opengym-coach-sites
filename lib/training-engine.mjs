...
export function recommendProgression({ policy = "off", mode = "reps", previousSets = [], targetReps = 10, minReps = Math.max(1, targetReps - 2), targetSeconds = 30, increment = 2.5, timeIncrement = 5, stalls = 0 }) {
